...
class AlienFleet:
    ...
    alien_images0 = [pg.transform.rotozoom(pg.image.load(f'images/RedAlien{n}.png'), 0, 1) for n in range(2)]
    alien_images1 = [pg.transform.rotozoom(pg.image.load(f'images/SkyAlien{n}.png'), 0, 1) for n in range(2)]
    alien_images2 = [pg.transform.rotozoom(pg.image.load(f'images/OrangeAlien{n}.png'), 0, 1) for n in range(2)]
